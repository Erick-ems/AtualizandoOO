...
public class Teste extends javax.swing.JFrame {
    ...
    public void LoadTable(){
        ...
        tbl_carros.getColumnModel().getColumn(0).setPreferredWidth(200);
        tbl_carros.getColumnModel().getColumn(1).setPreferredWidth(300);
    }
    ...
    private void initComponents() {
        ...
        tbl_carros.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_carrosMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbl_carros);
        if (tbl_carros.getColumnModel().getColumnCount() > 0) {
            tbl_carros.getColumnModel().getColumn(0).setPreferredWidth(200);
            tbl_carros.getColumnModel().getColumn(1).setPreferredWidth(200);
        }
    ...
    private void tbl_carrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_CarrosMouseClicked
        Botoes(true,true,true,false,false);
        int index = tbl_carros.getSelectedRow();
        if(index>=0 && index<Modelo.getRowCount()){
            String temp[] = Modelo.getCarro(index);
            c_mat.setText(temp[0]);
            c_Ano.setText(temp[1]);
        }
    }//GEN-LAST:event_tbl_CarrosMouseClicked
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvarActionPerformed
        if( ControllerCarro.SalvarCarro(c_mat.getText(),c_Ano.getText(), getTitle(), getTitle(), getTitle(), getTitle(), getTitle()) ){
            this.LoadTable();
            JOptionPane.showMessageDialog(this, "Carro salvo com sucesso!");
        }else
            JOptionPane.showMessageDialog(this, "Erro ao salvar o Carro!");
